...
export var TRAINS: Train[] = [
  ...
  {id: 24, name: 'Argo Parahyangan', date_id: 1, departure_on: new Date('2016-11-09T11:50:00'), arrive_on: new Date('2016-11-09T14:57:00'),  departure_in : 1,  arrive_in : 2, duration: 187, price: 120000, slot: 120}
];
