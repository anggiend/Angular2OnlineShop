...
var routes = [
    ...
    { path: 'train/:date/:departure/:arrive/:slot', component: list_train_component_1.ListTrainComponent },
    { path: 'booking/:id/:slot', component: booking_component_1.BookingComponent },
